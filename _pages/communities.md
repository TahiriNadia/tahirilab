...
<div class="row clearfix">
  <div class="column left">
  <img src="{{ site.url }}{{ site.baseurl }}/images/logopic/logo_gdg.png" class="img-responsive" width="90%" style="padding: 3px; float: left" />
   </div>
  <div class="column right">
...
<div class="row clearfix">
  <div class="column left">
  <img src="{{ site.url }}{{ site.baseurl }}/images/logopic/logo_WTM.png" class="img-responsive" width="90%" style="padding: 3px; float: left" />
   </div>
  <div class="column right">
